...
//		}
//		// lu.zhang.dp[i] 在0~i范围上，随意选一个子数组，累加和最大是多少？
//		int[] lu.zhang.dp = new int[N];
//		lu.zhang.dp[0] = help[0];
//		for (int i = 1; i < N; i++) {
//			int p1 = help[i];
//			int p2 = lu.zhang.dp[i - 1];
//			lu.zhang.dp[i] = Math.max(p1, p2);
//		}
//		return lu.zhang.dp;
//	}
//
