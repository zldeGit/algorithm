...
public class QuickSort {
  ...
  /**
   * 荷兰国旗问题: 给定一个数组和一个int x,修改数组 使得数组中任意数字i满足 i <=x 在左边,i>x在右边
   */
  ...
  /**
   * 荷兰国旗问题2: 给定一个数组和一个int x,修改数组 使得数组中任意数字i满足 i <x 在左边,i>x在右边,i=x在中间
   */
  //假设x =arr[r]
  ...
  /**
   * 荷兰国旗问题2+随机选择: 给定一个数组和一个int x,修改数组 使得数组中任意数字i满足 i <x 在左边,i>x在右边,i=x在中间
   */
  //假设x =arr[r]
